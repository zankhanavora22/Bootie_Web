				...
				<nav class="py-4">
					...
					<ul class="menu mt-2">
						...
						<li>
							...
							<ul>
								<li><a href="Seller_registration.jsp">As Seller</a></li>
								<li><a href="Customer_registration.jsp">As Customer </a></li>
						...
						<li>
							<!-- First Tier Drop Down --> <label for="drop-2" class="toggle">Drop
								...
								aria-hidden="true"></span></a> <input type="checkbox" id="drop-2" />
							<ul>
								<li><a href="Admin_login.jsp">As Admin</a></li>
								<li><a href="seller_login.jsp">As Seller</a></li>
								<li><a href="Customer_login">As Customer </a></li>
